              ...
              children: [
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      await launchURL(
                          'https://docs.google.com/forms/d/e/1FAIpQLSdI4bzN5Fl5NdmiMfTCndjx0Ny0xgxSeQhcRuRikqc6LNB7RQ/viewform?usp=sf_link');
                    },
                    child: Container(
                      width: double.infinity,
                      height: 60.0,
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      await launchURL(
                          'https://docs.google.com/forms/d/e/1FAIpQLSdUq0UaX8HGLGin0euK4w3oYDetqEuIwWLv4AGHy_4UV-fVgw/viewform?usp=sf_link');
                    },
                    child: Container(
                      width: double.infinity,
                      height: 60.0,
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      await launchUrl(Uri(
                          scheme: 'mailto',
                          path: 'yuvasankaranagasrisai_thota@srmap.edu.in',
                          query: {
                            'subject': 'Feedback for SRMAP: Mess App',
                          }
                              .entries
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      unawaited(
                        () async {
                          await launchURL('https://srmapmess.vercel.app/');
                        }(),
                      );
                    },
                    child: Container(
