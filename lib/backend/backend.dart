...
Future<int> queryItemsDetailsRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      ItemsDetailsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ItemsDetailsRecord>> queryItemsDetailsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ItemsDetailsRecord.collection,
      ItemsDetailsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ItemsDetailsRecord>> queryItemsDetailsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query HostlerDayscholarRecords (as a Stream and as a Future).
Future<int> queryHostlerDayscholarRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      HostlerDayscholarRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<HostlerDayscholarRecord>> queryHostlerDayscholarRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      HostlerDayscholarRecord.collection,
      HostlerDayscholarRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<HostlerDayscholarRecord>> queryHostlerDayscholarRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
