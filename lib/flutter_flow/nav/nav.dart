...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/mainindex',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'mainindex')
              : const MainindexWidget(),
        ),
        FFRoute(
          name: 'pageinfo',
          path: '/pageinfo',
          builder: (context, params) => PageinfoWidget(
            pass: params
                .getParam('pass', ParamType.DocumentReference, false, ['mess']),
          ),
        ),
        FFRoute(
          name: 'settings',
        ...
        FFRoute(
          ...
          asyncParams: {
            'itemSelection':
                getDoc(['Menu-Items'], MenuItemsRecord.fromSnapshot),
          },
          builder: (context, params) => ItemdetailsWidget(
            itemSelection: params.getParam('itemSelection', ParamType.Document),
          ),
        ),
        FFRoute(
          name: 'authentication',
